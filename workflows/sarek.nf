...
normal_vcf         = params.normal_vcf         ? Channel.fromPath(params.normal_vcf).collect()               : Channel.fromPath( '/dummy.vcf' )// EXPERIMENTAL: Passing normal germline vcf into ClairS to skip normal germline variant calling
